...
class Settings(BaseSettings):
    ...
    elevenlabs_llm_model: str = "Qwen3.6-35B-A3B"
    ...
    cluster_join_distance_m: int = Field(default=10000, ge=100, le=100000)
    cluster_join_window_minutes: int = Field(default=45, ge=1, le=1440)
    ...
    def public_config(self) -> dict[str, object]:
        return {
            ...
            "voice": {
                ...
                "llm_model": self.elevenlabs_llm_model,
            ...
            "search": {"configured": bool(self.brave_search_api_key), "default_enabled": False},
            "sources": {
