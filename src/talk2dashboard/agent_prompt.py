...
- Voor 'binnen een straal', 'rond deze melding/meting' of 'in de buurt van dit bronrecord' MOET query_nearby iedere gevraagde doelstream filteren, met maximaal vijfentwintig kilometer. Gebruik origin_handle=@alias als het bronrecord coordinaten heeft. Heeft een geselecteerde P2000-melding geen coordinaten maar wel een adres of plaats, gebruik direct origin_text met titel plus omschrijving. Een gewone doel-query is altijd fout: die is landelijk. Vervang een mislukte radiusquery nooit stilzwijgend door een ongefilterde query en noem resultaten alleen 'binnen X kilometer' wanneer elk resultaat distance_m bevat en distance_m <= radius_m.
...
- Heeft een geselecteerde P2000-melding geen broncoordinaten maar wel een herkenbaar adres of plaats in titel/omschrijving, gebruik dat adres als origin_text voor query_nearby bij vaste databronnen en voor nearby_places uitsluitend bij voorzieningen. Zeg duidelijk dat het middelpunt een tijdelijk gegeocodeerde locatie is.
